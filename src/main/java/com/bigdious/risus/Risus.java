...
public class Risus {
	...
	public Risus(IEventBus bus, Dist dist) {
		...
		ExecrationEffects.ENTITY_EFFECTS.register(bus);
		...
		RisusFeatures.FEATURES.register(bus);
	...
	public void registerPackets(RegisterPayloadHandlersEvent event) {
		...
		registrar.playToServer(WingAttackPacket.TYPE, WingAttackPacket.STREAM_CODEC,(payload, context) -> WingAttackPacket.handle(context));
