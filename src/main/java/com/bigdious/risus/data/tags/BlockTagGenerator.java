...
public class BlockTagGenerator extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		this.tag(BlockTags.WALLS).add(
			...
			RisusBlocks.WHITE_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.LIGHT_GRAY_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.GRAY_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.BLACK_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.BROWN_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.RED_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.ORANGE_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.YELLOW_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.LIME_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.GREEN_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.CYAN_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.LIGHT_BLUE_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.BLUE_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.PURPLE_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.MAGENTA_MOSAIC_GLASS_PANE.get(),
			RisusBlocks.PINK_MOSAIC_GLASS_PANE.get(),
