...
public class LangGenerator extends RisusLangProvider {
	...
	protected void addTranslations() {
		...
		this.addBlock(RisusBlocks.FOSSIL_FRAGMENTED, "Fragmented Fossil");
		...
		this.addItem(RisusItems.SACRIFICE_CATALYST, "Crucified Heart");
		...
		this.add("tooltip.risus.ability.default", "Empty -");
		this.add("tooltip.risus.ability.skeleton", "Skeleton Mask - ");
		this.add("tooltip.risus.ability.creeper", "Creeper Mask -");
		this.add("tooltip.risus.ability.wither_skeleton", "Wither Skeleton Mask -");
		this.add("tooltip.risus.ability.zombie", "Zombie Mask -");
		this.add("tooltip.risus.ability.piglin", "Piglin Mask -");
		this.add("tooltip.risus.ability.tuxedo_cat", "Tuxedo Cat Mask -");
		this.add("tooltip.risus.ability.black_cat", "Black Cat Mask -");
		this.add("tooltip.risus.ability.british_cat", "Shorthair Cat Mask -");
		this.add("tooltip.risus.ability.calico_cat", "Calico Cat Mask -");
		this.add("tooltip.risus.ability.jellie_cat", "Jellie Cat Mask -");
		this.add("tooltip.risus.ability.persian_cat", "Persian Cat Mask -");
		this.add("tooltip.risus.ability.ragdoll_cat", "Ragdoll Cat Mask -");
		this.add("tooltip.risus.ability.orange_cat", "Orange Cat Mask -");
		this.add("tooltip.risus.ability.siamese_cat", "Siamese Cat Mask -");
		this.add("tooltip.risus.ability.tabby_cat", "Tabby Cat Mask -");
		this.add("tooltip.risus.ability.white_cat", "White Cat Mask -");
		this.add("tooltip.risus.ability.audrey_cat", "Audrey Mask -");
		this.add("tooltip.risus.ability.spyglass", "Spyglass Goggles -");
		this.add("tooltip.risus.ability.pumpkin", "Pumpkin Mask -");
		this.add("tooltip.risus.ability.pale_wolf", "Pale Wolf Mask -");
		this.add("tooltip.risus.ability.ashen_wolf", "Ashen Wolf Mask -");
		this.add("tooltip.risus.ability.black_wolf", "Black Wolf Mask -");
		this.add("tooltip.risus.ability.chestnut_wolf", "Chestnut Wolf Mask -");
		this.add("tooltip.risus.ability.rusty_wolf", "Rusty Wolf Mask -");
		this.add("tooltip.risus.ability.snowy_wolf", "Snowy Wolf Mask -");
		this.add("tooltip.risus.ability.spotted_wolf", "Spotted Wolf Mask -");
		this.add("tooltip.risus.ability.striped_wolf", "Striped Wolf Mask -");
		this.add("tooltip.risus.ability.woods_wolf", "Woods Wolf Mask -");
		this.add("tooltip.risus.ability.bleached_eye", "Bleached Eye Mask -");
		this.add("tooltip.risus.ability.bloodshot_eye", "Bloodshot Eye Mask -");
		this.add("tooltip.risus.ability.emerald_eye", "Emerald Eye Mask -");
		this.add("tooltip.risus.ability.ender_eye", "Ender Eye Mask -");
		this.add("tooltip.risus.ability.golden_eye", "Golden Eye Mask -");
		this.add("tooltip.risus.ability.abyssal_eye", "Abyssal Eye Mask -");
		this.add("tooltip.risus.ability.smile", "Smile Mask -");
		this.add("tooltip.risus.ability.great_stool", "Great Stool -");
		this.add("tooltip.risus.ability.fox", "Fox Mask -");
		this.add("tooltip.risus.ability.snow_fox", "Snow Fox Mask -");
		this.add("tooltip.risus.ability.guts", "Gorger Guts -");
		...
		this.add("tooltip.risus.ability.zombie.desc", "Less noticed by Zombies");
		this.add("tooltip.risus.ability.piglin.desc", "Piglins are Neutral");
		this.add("tooltip.risus.ability.tuxedo_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.black_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.british_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.calico_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.jellie_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.persian_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.ragdoll_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.orange_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.siamese_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.tabby_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.white_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.audrey_cat.desc", "Barely noticed by Phantoms");
		this.add("tooltip.risus.ability.pumpkin.desc", "Ignored by Endermen");
		this.add("tooltip.risus.ability.pale_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.ashen_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.black_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.chestnut_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.rusty_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.snowy_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.spotted_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.striped_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.woods_wolf.desc", "Slightly less noticed by Skeletons");
		this.add("tooltip.risus.ability.bleached_eye.desc", "Immune to Stalkers");
		this.add("tooltip.risus.ability.bloodshot_eye.desc", "Immune to Stalkers");
		this.add("tooltip.risus.ability.emerald_eye.desc", "Immune to Stalkers");
		this.add("tooltip.risus.ability.ender_eye.desc", "Immune to Stalkers");
		this.add("tooltip.risus.ability.golden_eye.desc", "Immune to Stalkers");
		this.add("tooltip.risus.ability.abyssal_eye.desc", "Less noticed by Offsprings");
		this.add("tooltip.risus.ability.smile.desc", "Less noticed by Offsprings");
		this.add("tooltip.risus.ability.fox.desc", "Less noticed by Rabbits");
		this.add("tooltip.risus.ability.snow_fox.desc", "Less noticed by Rabbits");
		this.add("tooltip.risus.ability.great_stool.button_press", "Press the %s key for Greatness");
		this.add("tooltip.risus.ability.spyglass.button_press", "Press the %s key to toggle Zoom");
