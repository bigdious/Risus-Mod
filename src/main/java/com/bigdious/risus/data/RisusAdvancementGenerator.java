...
//			.requirements(AdvancementRequirements.Strategy.OR)
			...
			AdvancementHolder mod_book = Advancement.Builder.advancement().parent(site_zero).display(
				PatchouliAPI.get().getBookStack(ResourceLocation.fromNamespaceAndPath(Risus.MODID,"research_notes")).getItem(),
				...
				.addCriterion("modbook", InventoryChangeTrigger.TriggerInstance.hasItems(PatchouliAPI.get().getBookStack(ResourceLocation.fromNamespaceAndPath(Risus.MODID,"research_notes")).getItem()))
