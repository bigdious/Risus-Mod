...
public class ItemModelGenerator extends ItemModelProvider {
	...
	protected void registerModels() {
		...
		toBlockModel(RisusBlocks.WHITE_MOSAIC_LAMP.get(), Risus.prefix("block/white_mosaic_glass"));
		toBlockModel(RisusBlocks.LIGHT_GRAY_MOSAIC_LAMP.get(), Risus.prefix("block/light_gray_mosaic_glass"));
		toBlockModel(RisusBlocks.GRAY_MOSAIC_LAMP.get(), Risus.prefix("block/gray_mosaic_glass"));
		toBlockModel(RisusBlocks.BLACK_MOSAIC_LAMP.get(), Risus.prefix("block/black_mosaic_glass"));
		toBlockModel(RisusBlocks.BROWN_MOSAIC_LAMP.get(), Risus.prefix("block/brown_mosaic_glass"));
		toBlockModel(RisusBlocks.RED_MOSAIC_LAMP.get(), Risus.prefix("block/red_mosaic_glass"));
		toBlockModel(RisusBlocks.ORANGE_MOSAIC_LAMP.get(), Risus.prefix("block/orange_mosaic_glass"));
		toBlockModel(RisusBlocks.YELLOW_MOSAIC_LAMP.get(), Risus.prefix("block/yellow_mosaic_glass"));
		toBlockModel(RisusBlocks.LIME_MOSAIC_LAMP.get(), Risus.prefix("block/lime_mosaic_glass"));
		toBlockModel(RisusBlocks.GREEN_MOSAIC_LAMP.get(), Risus.prefix("block/green_mosaic_glass"));
		toBlockModel(RisusBlocks.CYAN_MOSAIC_LAMP.get(), Risus.prefix("block/cyan_mosaic_glass"));
		toBlockModel(RisusBlocks.LIGHT_BLUE_MOSAIC_LAMP.get(), Risus.prefix("block/light_blue_mosaic_glass"));
		toBlockModel(RisusBlocks.BLUE_MOSAIC_LAMP.get(), Risus.prefix("block/blue_mosaic_glass"));
		toBlockModel(RisusBlocks.PURPLE_MOSAIC_LAMP.get(), Risus.prefix("block/purple_mosaic_glass"));
		toBlockModel(RisusBlocks.MAGENTA_MOSAIC_LAMP.get(), Risus.prefix("block/magenta_mosaic_glass"));
		toBlockModel(RisusBlocks.PINK_MOSAIC_LAMP.get(), Risus.prefix("block/pink_mosaic_glass"));
