...
public class ItemModelGenerator extends ItemModelProvider {
	...
	protected void registerModels() {
		...
		toBlockModel(RisusBlocks.TESSERACT.get(), Risus.prefix("block/tesseract_with_feather"));
		...
		toBlock(RisusBlocks.WHITE_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.LIGHT_GRAY_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.GRAY_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.BLACK_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.BROWN_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.RED_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.ORANGE_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.YELLOW_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.LIME_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.GREEN_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.CYAN_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.LIGHT_BLUE_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.BLUE_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.PURPLE_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.MAGENTA_MOSAIC_GLASS.get());
		toBlock(RisusBlocks.PINK_MOSAIC_GLASS.get());
		generatedRenderType(RisusBlocks.WHITE_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/white_mosaic_glass"));
		generatedRenderType(RisusBlocks.LIGHT_GRAY_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/light_gray_mosaic_glass"));
		generatedRenderType(RisusBlocks.GRAY_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/gray_mosaic_glass"));
		generatedRenderType(RisusBlocks.BLACK_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/black_mosaic_glass"));
		generatedRenderType(RisusBlocks.BROWN_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/brown_mosaic_glass"));
		generatedRenderType(RisusBlocks.RED_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/red_mosaic_glass"));
		generatedRenderType(RisusBlocks.ORANGE_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/orange_mosaic_glass"));
		generatedRenderType(RisusBlocks.YELLOW_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/yellow_mosaic_glass"));
		generatedRenderType(RisusBlocks.LIME_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/lime_mosaic_glass"));
		generatedRenderType(RisusBlocks.GREEN_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/green_mosaic_glass"));
		generatedRenderType(RisusBlocks.CYAN_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/cyan_mosaic_glass"));
		generatedRenderType(RisusBlocks.LIGHT_BLUE_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/light_blue_mosaic_glass"));
		generatedRenderType(RisusBlocks.BLUE_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/blue_mosaic_glass"));
		generatedRenderType(RisusBlocks.PURPLE_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/purple_mosaic_glass"));
		generatedRenderType(RisusBlocks.MAGENTA_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/magenta_mosaic_glass"));
		generatedRenderType(RisusBlocks.PINK_MOSAIC_GLASS_PANE.getId().getPath(), "minecraft:translucent", Risus.prefix("block/pink_mosaic_glass"));
		toBlock(RisusBlocks.WHITE_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.LIGHT_GRAY_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.GRAY_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.BLACK_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.BROWN_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.RED_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.ORANGE_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.YELLOW_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.LIME_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.GREEN_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.CYAN_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.LIGHT_BLUE_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.BLUE_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.PURPLE_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.MAGENTA_MOSAIC_LAMP.get());
		toBlock(RisusBlocks.PINK_MOSAIC_LAMP.get());
		...
		singleTex(RisusBlocks.EERIE_LARGE_GATE.get());
		singleTex(RisusBlocks.DARK_LARGE_GATE.get());
		...
		getBuilder(RisusBlocks.GRIMSTONE_BLOOD_TILES_WALL.getId().getPath())
			.parent(getExistingFile(ResourceLocation.withDefaultNamespace("block/wall_inventory")))
		...
		singleTex(RisusItems.ANGEL_WINGS)
			...
			.override().predicate(Risus.prefix("oily"), 1.0F).predicate(Risus.prefix("broken"), 1.0F).model(singleTex("oily_wings_broken")).end()
			.override().predicate(Risus.prefix("oxidizing"), 1.0F).model(singleTex("oxidizing_wings")).end()
			.override().predicate(Risus.prefix("oxidizing"), 1.0F).predicate(Risus.prefix("broken"), 1.0F).model(singleTex("oxidizing_wings_broken"));
		singleTex(RisusItems.DIAMOND_TIPPED_ANGEL_WINGS)
			...
			.override().predicate(Risus.prefix("oily"), 1.0F).predicate(Risus.prefix("broken"), 1.0F).model(singleTex("diamond_tipped_oily_wings_broken")).end()
			.override().predicate(Risus.prefix("oxidizing"), 1.0F).model(singleTex("diamond_tipped_oxidizing_wings")).end()
			.override().predicate(Risus.prefix("oxidizing"), 1.0F).predicate(Risus.prefix("broken"), 1.0F).model(singleTex("diamond_tipped_oxidizing_wings_broken"));
		...
		singleTex(RisusItems.HOLDER_BUCKET);
		...
		var sowScythe = handheldItem(RisusItems.SCYTHE,"_sow", withExistingParent("sow_scythe_held", Risus.prefix("item/template_held_scythe_sow")), Risus.prefix("item/scythe"), Risus.prefix("item/scythe_sow_item"), "texture");
		handheldItem(RisusItems.SCYTHE, withExistingParent("scythe_held", Risus.prefix("item/template_held_scythe")), Risus.prefix("item/scythe"), Risus.prefix("item/scythe_item"), "texture")
			...
			.override().predicate(Risus.prefix("sow"), 1).model(sowScythe).end();
		...
		var sowSoulScythe = handheldItem(RisusItems.SOUL_SCYTHE,"_sow", withExistingParent("noanim_soul_scythe_held", Risus.prefix("item/template_held_scythe_sow")), Risus.prefix("item/soul_scythe"), Risus.prefix("item/soul_scythe_sow_item"), "texture");
		handheldItem(RisusItems.SOUL_SCYTHE, withExistingParent("soul_scythe_held", Risus.prefix("item/template_held_scythe")), Risus.prefix("item/soul_scythe"), Risus.prefix("item/soul_scythe_item"), "texture")
			...
			.override().predicate(Risus.prefix("sow"), 1).model(sowSoulScythe).end();
		...
		var sowFireScythe = handheldItem(RisusItems.FIRE_SCYTHE, "_sow",withExistingParent("noanim_fire_scythe_held", Risus.prefix("item/template_held_scythe_sow")), Risus.prefix("item/fire_scythe"), Risus.prefix("item/fire_scythe_sow_item"), "texture");
		handheldItem(RisusItems.FIRE_SCYTHE, withExistingParent("fire_scythe_held", Risus.prefix("item/template_held_scythe")), Risus.prefix("item/fire_scythe"), Risus.prefix("item/fire_scythe_item"), "texture")
			...
			.override().predicate(Risus.prefix("sow"), 1).model(sowFireScythe).end();
		...
		var sowCindergleeScythe = handheldItem(RisusItems.CINDERGLEE_SCYTHE, "_sow",withExistingParent("noanim_cinderglee_scythe_held", Risus.prefix("item/template_held_scythe_sow")), Risus.prefix("item/cinderglee_scythe"), Risus.prefix("item/cinderglee_scythe_sow_item"), "texture");
		handheldItem(RisusItems.CINDERGLEE_SCYTHE, withExistingParent("cinderglee_scythe_held", Risus.prefix("item/template_held_scythe")), Risus.prefix("item/cinderglee_scythe"), Risus.prefix("item/cinderglee_scythe_item"), "texture")
			...
			.override().predicate(Risus.prefix("sow"), 1).model(sowCindergleeScythe).end();
...
//		handheldItem(RisusItems.HAND_OF_GREED, getExistingFile(Risus.prefix("item/hand_of_greed_held")), Risus.prefix("item/hand_of_greed"), Risus.prefix("item/hand_of_greed_item"), "hand_of_greed");
		...
		generatedRenderType(RisusBlocks.ASHEN_SPIRE.getId().getPath(), "minecraft:cutout", Risus.prefix("item/ashen_spire_item"));
