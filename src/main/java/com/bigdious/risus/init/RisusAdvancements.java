...
public class RisusAdvancements {
	...
	public static final DeferredHolder<CriterionTrigger<?>, CreateWeavingMechanismTrigger> CREATE_WEAVING_MECHANISM = TRIGGERS.register("create_weaving_mechanism", CreateWeavingMechanismTrigger::new);
