...
public class RisusEntities {
	...
	public static final RegistryObject<EntityType<Lover>> LOVER = register(new ResourceLocation(Risus.MODID, "lover"), EntityType.Builder.of(Lover::new, MobCategory.MONSTER).sized(1F, 1F), 0x000000, 0x8b0000);
	public static final RegistryObject<EntityType<Stalker>> STALKER = register(new ResourceLocation(Risus.MODID, "stalker"), EntityType.Builder.of(Stalker::new, MobCategory.MONSTER).sized(0.6F, 1.8F), 0x000000, 0x8b0000);
