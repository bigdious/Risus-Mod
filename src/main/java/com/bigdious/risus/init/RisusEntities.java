...
public class RisusEntities {
	...
	public static final RegistryObject<EntityType<Weaver>> WEAVER = register(new ResourceLocation(Risus.MODID, "weaver"), EntityType.Builder.of(Weaver::new, MobCategory.MONSTER).sized(0.75F, 0.75F), 0x000000, 0x8b0000);
