...
public class RisusEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<QuestionMark>> QUESTION_MARK = register(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "question_mark"), EntityType.Builder.of(QuestionMark::new, MobCategory.MONSTER).sized(3F, 3F), 0x000000, 0x8b0000);
	public static final DeferredHolder<EntityType<?>, EntityType<TransientQuestionMark>> TRANSIENT_QUESTION_MARK = register(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "transient_question_mark"), EntityType.Builder.of(TransientQuestionMark::new, MobCategory.MONSTER).sized(3F, 3F), 0x000000, 0x8b0000);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<Licker>> LICKER = register(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "licker"), EntityType.Builder.of(Licker::new, MobCategory.MONSTER).sized(0.8F, 2F), 0x000000, 0x8b0000);
