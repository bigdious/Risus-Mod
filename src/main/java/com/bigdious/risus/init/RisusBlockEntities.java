...
public class RisusBlockEntities {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<CoalificationBlockEntity>> COALIFICATION = BLOCK_ENTITIES.register("coalification", () -> BlockEntityType.Builder.of(CoalificationBlockEntity::new, RisusBlocks.COALIFICATION.get()).build(null));
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BeatingHeartBlockEntity>> BEATING_HEART = BLOCK_ENTITIES.register("beating_heart", () -> BlockEntityType.Builder.of(BeatingHeartBlockEntity::new, RisusBlocks.BEATING_HEART.get()).build(null));
}
