...
public class RisusItems {
	...
	public static final DeferredItem<Item> CARVING_KNIFE = register("carving_knife", properties -> new CarvingKnifeItem(Tiers.IRON, properties), () -> new Item.Properties().attributes(CarvingKnifeItem.createKnifeAttributes(Tiers.IRON, 0, -2.0F)).rarity(BLOOD));
	public static final DeferredItem<Item> SCYTHE = register("scythe", properties -> new ScytheItem(RisusToolMaterials.GLUTTONY, RisusTags.Enchantments.SCYTHE_ALLOWED_ENCHANTS, properties), () -> new Item.Properties().fireResistant().component(RisusDataComponents.SOWING, false).rarity(BLOOD));
	public static final DeferredItem<Item> FIRE_SCYTHE = register("fire_scythe", properties -> new ScytheItem(RisusToolMaterials.GLUTTONY, RisusTags.Enchantments.FIRE_SCYTHE_ALLOWED_ENCHANTS, properties), () -> new Item.Properties().fireResistant().component(RisusDataComponents.SOWING, false).rarity(BLOOD));
	public static final DeferredItem<Item> SOUL_SCYTHE = register("soul_scythe", properties -> new ScytheItem(RisusToolMaterials.GLUTTONY, RisusTags.Enchantments.SOUL_SCYTHE_ALLOWED_ENCHANTS, properties), () -> new Item.Properties().fireResistant().component(RisusDataComponents.SOWING, false).rarity(BLOOD));
	public static final DeferredItem<Item> CINDERGLEE_SCYTHE = register("cinderglee_scythe", properties -> new ScytheItem(RisusToolMaterials.GLUTTONY, RisusTags.Enchantments.CINDERGLEE_SCYTHE_ALLOWED_ENCHANTS, properties), () -> new Item.Properties().fireResistant().component(RisusDataComponents.SOWING, false).rarity(BLOOD));
	...
	public static final DeferredItem<Item> WARHORN = register("warhorn", properties -> new WarhornItem(properties, InstrumentTags.GOAT_HORNS), () -> new Item.Properties().stacksTo(1).durability(64).rarity(BLOOD).fireResistant().component(RisusDataComponents.WARHORN_CONTENT, WarhornComponent.EMPTY));
	public static final DeferredItem<Item> HEXHORN = register("hexhorn", properties -> new HexhornItem(properties, InstrumentTags.GOAT_HORNS), () -> new Item.Properties().stacksTo(1).durability(64).rarity(BLOOD).fireResistant().component(RisusDataComponents.WARHORN_CONTENT, WarhornComponent.EMPTY));
	...
	public static final DeferredItem<Item> LOST_WILL = register("lost_will", LostWillItem::new, () -> new Item.Properties().rarity(BLOOD).stacksTo(1));
	...
	public static final DeferredItem<Item> BLOOD_FEATHER = register("blood_feather", BloodFeatherItem::new, () -> new Item.Properties().fireResistant().rarity(BLOOD));
