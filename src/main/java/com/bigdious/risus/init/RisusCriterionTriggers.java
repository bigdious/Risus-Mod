...
public class RisusCriterionTriggers {
	...
	public static final DeferredHolder<CriterionTrigger<?>, BasicBTrigger> CARVED = TRIGGERS.register("carved", BasicBTrigger::new);
	public static final DeferredHolder<CriterionTrigger<?>, BasicBTrigger> DISCOVER = TRIGGERS.register("discover", BasicBTrigger::new);
