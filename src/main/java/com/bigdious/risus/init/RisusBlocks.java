...
public class RisusBlocks {
	...
	public static final DeferredBlock<Block> MIRAGE_GRASS_BLOCK = registerWithItem("mirage_grass_block", properties -> new MirageBlock(properties, Blocks.GRASS_BLOCK), () -> Block.Properties.ofFullCopy(Blocks.GRASS_BLOCK).noOcclusion().forceSolidOn());
