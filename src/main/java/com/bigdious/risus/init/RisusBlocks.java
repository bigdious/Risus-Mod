...
public class RisusBlocks {
	...
	public static final DeferredBlock<Block> DARKNESS = registerWithItem("darkness", DarknessBlock::new, () -> BlockBehaviour.Properties.of().pushReaction(PushReaction.DESTROY).instabreak().replaceable());
