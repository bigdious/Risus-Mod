...
public class RisusBlocks {
	...
	public static final DeferredBlock<StairBlock> BONDKNOT_STAIRS = BLOCKS.register("bondknot_stairs", () -> new RisusStairBlock(() -> BONDKNOT_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BONDKNOT_PLANKS.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<SlabBlock> BONDKNOT_SLAB = BLOCKS.register("bondknot_slab", () -> new RisusSlabBlock(BlockBehaviour.Properties.ofFullCopy(BONDKNOT_PLANKS.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<FenceBlock> BONDKNOT_FENCE = BLOCKS.register("bondknot_fence", () -> new RisusFenceBlock(BlockBehaviour.Properties.ofFullCopy(BONDKNOT_PLANKS.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<TrapDoorBlock> BONDKNOT_TRAPDOOR = BLOCKS.register("bondknot_trapdoor", () -> new RisusTrapDoorBlock(BONDKNOT_SET, BlockBehaviour.Properties.ofFullCopy(BONDKNOT_PLANKS.get()).noOcclusion().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<StandingSignBlock> BONDKNOT_SIGN = BLOCKS.register("bondknot_sign", () -> new RisusSignBlock(BlockBehaviour.Properties.ofFullCopy(BONDKNOT_PLANKS.get()).noOcclusion().noCollission().forceSolidOn().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0), RisusBlocks.BONDKNOT_TYPE));
	public static final DeferredBlock<WallSignBlock> BONDKNOT_WALL_SIGN = BLOCKS.register("bondknot_wall_sign", () -> new RisusWallSignBlock(RisusBlocks.BONDKNOT_TYPE, BlockBehaviour.Properties.ofFullCopy(BONDKNOT_PLANKS.get()).noOcclusion().noCollission().forceSolidOn().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<CeilingHangingSignBlock> BONDKNOT_HANGING_SIGN = BLOCKS.register("bondknot_hanging_sign", () -> new RisusCeilingHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(BONDKNOT_PLANKS.get()).noOcclusion().noCollission().forceSolidOn().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0), RisusBlocks.BONDKNOT_TYPE));
	public static final DeferredBlock<WallHangingSignBlock> BONDKNOT_WALL_HANGING_SIGN = BLOCKS.register("bondknot_wall_hanging_sign", () -> new RisusWallHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(BONDKNOT_PLANKS.get()).noOcclusion().forceSolidOn().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0), RisusBlocks.BONDKNOT_TYPE));
	public static final DeferredBlock<Block> BABY_RIBCAGE = BLOCKS.register("baby_ribcage", () -> new BabyRibcageBlock(Block.Properties.ofFullCopy(Blocks.BONE_BLOCK).noOcclusion().forceSolidOn().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<Block> RIBCAGE = BLOCKS.register("ribcage", () -> new RibcageBlock(Block.Properties.ofFullCopy(Blocks.BONE_BLOCK).noOcclusion().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<Block> BOND_GLASS = BLOCKS.register("bond_glass", () -> new RisusGlassBlock(Block.Properties.ofFullCopy(Blocks.GLASS).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<Block> CONTAINMENT_GLASS = BLOCKS.register("containment_glass", () -> new RisusGlassBlock(Block.Properties.ofFullCopy(Blocks.GLASS).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<Block> ANGEL_ALTAR = BLOCKS.register("angel_altar", () -> new AngelAltar(Block.Properties.ofFullCopy(Blocks.OBSIDIAN).noOcclusion().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<Block> DEPTH_VASE = BLOCKS.register("depth_vase", () -> new DepthVaseBlock(Block.Properties.ofFullCopy(Blocks.DECORATED_POT).mapColor(MapColor.NONE).pushReaction(PushReaction.DESTROY).noOcclusion().strength(2.0F).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<Block> FLOWERING_IMITATION_SCALEPLATE = BLOCKS.register("flowering_imitation_scaleplate", () -> new ScaleplateBlock(Block.Properties.ofFullCopy(Blocks.ANCIENT_DEBRIS).noOcclusion().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<Block> BUDDING_IMITATION_SCALEPLATE = BLOCKS.register("budding_imitation_scaleplate", () -> new ScaleplateBlock(Block.Properties.ofFullCopy(Blocks.ANCIENT_DEBRIS).noOcclusion().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<MultifaceBlock> SPREADING_REMAINS = BLOCKS.register("spreading_remains", () -> new SpreadingRemainsBlock(Block.Properties.ofFullCopy(Blocks.SCULK_VEIN).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<RotatedPillarBlock> ENGRAVED_BASALT = BLOCKS.register("engraved_basalt", () -> new LoggingPillarBlock(Block.Properties.ofFullCopy(Blocks.POLISHED_BASALT).noOcclusion().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<Block> BIG_CHAIN = BLOCKS.register("big_chain", () -> new BigChainBlock(Block.Properties.ofFullCopy(Blocks.CHAIN).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<MultifaceBlock> TEETH = BLOCKS.register("teeth", () -> new SpreadingRemainsBlock(Block.Properties.ofFullCopy(Blocks.BONE_BLOCK).noOcclusion().lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<RisusGrowingPlantBodyBlock> NEURON_STEM = BLOCKS.register("neuron", () -> new NeuronStemBlock(Block.Properties.ofFullCopy(Blocks.TWISTING_VINES_PLANT).offsetType(BlockBehaviour.OffsetType.XZ).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<RisusGrowingPlantHeadBlock> NEURON_HEAD = BLOCKS.register("neuron_head", () -> new NeuronHeadBlock(Block.Properties.ofFullCopy(Blocks.TWISTING_VINES).offsetType(BlockBehaviour.OffsetType.XZ).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<RisusGrowingPlantBodyBlock> VEINS = BLOCKS.register("veins", () -> new VeinsBlock(Block.Properties.ofFullCopy(Blocks.WEEPING_VINES).offsetType(BlockBehaviour.OffsetType.XZ).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<RisusGrowingPlantHeadBlock> VEINS_END = BLOCKS.register("veins_end", () -> new VeinsEndBlock(Block.Properties.ofFullCopy(Blocks.WEEPING_VINES).offsetType(BlockBehaviour.OffsetType.XZ).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<SlabBlock> GRIMSTONE_BRICKS_SLAB = BLOCKS.register("grimstone_bricks_slab", () -> new RisusSlabBlock(BlockBehaviour.Properties.ofFullCopy(GRIMSTONE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<SlabBlock> POLISHED_GRIMSTONE_SLAB = BLOCKS.register("polished_grimstone_slab", () -> new RisusSlabBlock(BlockBehaviour.Properties.ofFullCopy(GRIMSTONE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<StairBlock> GRIMSTONE_BRICKS_STAIRS = BLOCKS.register("grimstone_bricks_stairs", () -> new RisusStairBlock(() -> GRIMSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(GRIMSTONE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<StairBlock> GRIMSTONE_STAIRS = BLOCKS.register("grimstone_stairs", () -> new RisusStairBlock(() -> GRIMSTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(GRIMSTONE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<StairBlock> POLISHED_GRIMSTONE_STAIRS = BLOCKS.register("polished_grimstone_stairs", () -> new RisusStairBlock(() -> GRIMSTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(GRIMSTONE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> GRIMSTONE_WALL = BLOCKS.register("grimstone_wall", () -> new RisusWallBlock(BlockBehaviour.Properties.ofFullCopy(GRIMSTONE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> GRIMSTONE_BRICKS_WALL = BLOCKS.register("grimstone_bricks_wall", () -> new RisusWallBlock(BlockBehaviour.Properties.ofFullCopy(GRIMSTONE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> POLISHED_GRIMSTONE_WALL = BLOCKS.register("polished_grimstone_wall", () -> new RisusWallBlock(BlockBehaviour.Properties.ofFullCopy(GRIMSTONE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<StairBlock> TISSUE_STAIRS = BLOCKS.register("tissue_stairs", () -> new RisusStairBlock(() -> TISSUE.get().defaultBlockState(), Block.Properties.ofFullCopy(RisusBlocks.TISSUE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<SlabBlock> TISSUE_SLAB = BLOCKS.register("tissue_slab", () -> new RisusSlabBlock(Block.Properties.ofFullCopy(RisusBlocks.TISSUE.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> ROTTING_TISSUE = BLOCKS.register("rotting_tissue", () -> new DecomposingTissueBlock(DecomposingBlock.DecomposeState.ROTTING, Block.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> DECOMPOSING_TISSUE = BLOCKS.register("decomposing_tissue", () -> new DecomposingTissueBlock(DecomposingBlock.DecomposeState.DECOMPOSING, Block.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> DECAYING_TISSUE = BLOCKS.register("decaying_tissue", () -> new DecomposingTissueBlock(DecomposingBlock.DecomposeState.DECAYING, Block.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<StairBlock> FULL_BONE_STAIRS = BLOCKS.register("full_bone_stairs", () -> new RisusStairBlock(Blocks.BONE_BLOCK::defaultBlockState, BlockBehaviour.Properties.ofFullCopy(Blocks.BONE_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<SlabBlock> FULL_BONE_SLAB = BLOCKS.register("full_bone_slab", () -> new RisusSlabBlock(BlockBehaviour.Properties.ofFullCopy(RisusBlocks.FULL_BONE_BLOCK.get()).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> BONE_WALL = BLOCKS.register("bone_wall", () -> new RisusWallBlock(Block.Properties.ofFullCopy(Blocks.BONE_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<StairBlock> BONE_STAIRS = BLOCKS.register("bone_stairs", () -> new RisusStairBlock(Blocks.BONE_BLOCK::defaultBlockState, BlockBehaviour.Properties.ofFullCopy(Blocks.BONE_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<SlabBlock> BONE_SLAB = BLOCKS.register("bone_slab", () -> new RisusSlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BONE_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<WallBlock> ROTTED_TISSUE = BLOCKS.register("rotted_tissue", () -> new RisusWallBlock(Block.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> DECOMPOSED_TISSUE = BLOCKS.register("decomposed_tissue", () -> new RisusWallBlock(Block.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<WallBlock> DECAYED_TISSUE = BLOCKS.register("decayed_tissue", () -> new RisusWallBlock(Block.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	public static final DeferredBlock<Block> EYE_ENDER = BLOCKS.register("eye_ender", () -> new EquipableEyeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK)));
	public static final DeferredBlock<Block> EYE_BLEACHED = BLOCKS.register("eye_bleached", () -> new EquipableEyeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK)));
	public static final DeferredBlock<Block> EYE_BLOODSHOT = BLOCKS.register("eye_bloodshot", () -> new EquipableEyeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK)));
	public static final DeferredBlock<Block> EYE_EMERALD = BLOCKS.register("eye_emerald", () -> new EquipableEyeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK)));
	public static final DeferredBlock<Block> EYE_GOLDEN = BLOCKS.register("eye_golden", () -> new EquipableEyeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_WART_BLOCK)));
	...
	public static final DeferredBlock<Block> TALL_HAIR = BLOCKS.register("tall_hair", () -> new RisusTallGrassBlock(Block.Properties.ofFullCopy(Blocks.TALL_GRASS).offsetType(BlockBehaviour.OffsetType.XYZ).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
	...
	public static final DeferredBlock<Block> JOYFLAME_CAMPFIRE = BLOCKS.register("joyflame_campfire", () -> new RisusCampfireBlock(true, 2, Block.Properties.ofFullCopy(Blocks.CAMPFIRE).lightLevel(state -> state.getValue(SimpleMultiloggedBlock.MultiloggingEnum.FLUIDLOGGED) == SimpleMultiloggedBlock.MultiloggingEnum.LAVA ? 15 : 0)));
