...
public class RisusArmorMaterials {
	...
	public static final DeferredHolder<ArmorMaterial, ArmorMaterial> SINNER_ROBE_HELMET = ARMOR_MATERIALS.register("sinner_robe_helmet", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
			map.put(ArmorItem.Type.HELMET, 1);
		}), 10, RisusSoundEvents.ARMOR_EQUIP_ROBE, () -> Ingredient.EMPTY, List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/helmet/base"), "_dyed", true), new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/helmet/cosmetic"), "", false), new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/helmet/upgrade"), "", false)), 0.0F, 0.0F)
	);
	...
	public static final DeferredHolder<ArmorMaterial, ArmorMaterial> SINNER_ROBE_CHESTPLATE = ARMOR_MATERIALS.register("sinner_robe_chestplate", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
			map.put(ArmorItem.Type.CHESTPLATE, 1);
		}), 10, RisusSoundEvents.ARMOR_EQUIP_ROBE, () -> Ingredient.EMPTY, List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/chestplate/base"), "_dyed", true), new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/chestplate/cosmetic"), "", false), new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/chestplate/upgrade"), "", false)), 0.0F, 0.0F)
	);
	...
	public static final DeferredHolder<ArmorMaterial, ArmorMaterial> SINNER_ROBE_LEGGINGS = ARMOR_MATERIALS.register("sinner_robe_leggings", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
			map.put(ArmorItem.Type.LEGGINGS, 1);
		}), 10, RisusSoundEvents.ARMOR_EQUIP_ROBE, () -> Ingredient.EMPTY, List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/leggings/base"), "_dyed", true), new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/leggings/cosmetic"), "", false), new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/leggings/upgrade"), "", false)), 0.0F, 0.0F)
	);
	...
	public static final DeferredHolder<ArmorMaterial, ArmorMaterial> SINNER_ROBE_BOOTS = ARMOR_MATERIALS.register("sinner_robe_boots", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
			map.put(ArmorItem.Type.BOOTS, 1);
		}), 10, RisusSoundEvents.ARMOR_EQUIP_ROBE, () -> Ingredient.EMPTY, List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/boots/base"), "_dyed", true), new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/boots/cosmetic"), "", false), new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Risus.MODID, "robe/boots/upgrade"), "", false)), 0.0F, 0.0F)
	);
