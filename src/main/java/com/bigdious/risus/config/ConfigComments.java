...
public final class ConfigComments {
	...
	public static final String ILLEGAL_LITTERS = """
		...
		Default: false
		Allows Litters to be made from non-full block light sources. Any block that gives off at least one light level will work, including brown mushrooms.""";
	...
	public static final String CUSTOM_WEAPON_ANIMS = """
		...
		Default: true
		Allows weapons like Scythes or Blade of a Thousand to have custom holding animations. It is advised to set it to false if Better Combat is installed.""";
