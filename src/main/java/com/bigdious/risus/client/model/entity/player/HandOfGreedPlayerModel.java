...
public class HandOfGreedPlayerModel extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition create() {
		...
		slimArm.addOrReplaceChild("outer_slim_arm", CubeListBuilder.create().texOffs(17, 0).addBox(-2.0F, 0.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.52F)), PartPose.ZERO);
	...
	public void setupAnim(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.arm.copyFrom(this.rightArm);
		this.slimArm.copyFrom(this.rightArm);
	}
