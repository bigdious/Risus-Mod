...
public class LoverModel<T extends Lover> extends HierarchicalModel<T> {
	...
	public static LayerDefinition create() {
		...
		PartDefinition firstmiddlebotteethright = bodythreequarter.addOrReplaceChild("firstmiddlebotteethright", CubeListBuilder.create().texOffs(28, 2).addBox(-1.0F, -3.8637F, -4.0353F, 1.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.637F, 4.0479F, -0.203F, 0.0886F, 0.3381F));

		PartDefinition firstmiddletopteethright = bodythreequarter.addOrReplaceChild("firstmiddletopteethright", CubeListBuilder.create().texOffs(23, 8).addBox(-1.9397F, 0.3417F, -4.5149F, 2.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.3827F, -3.3311F, 4.0172F, -0.2172F, -0.0427F, -0.2591F));
		...
		PartDefinition stalk5 = bodythreequarter.addOrReplaceChild("stalk5", CubeListBuilder.create().texOffs(17, 0).addBox(-2.2359F, -0.5111F, -0.4208F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.2641F, -3.4293F, 4.6798F, -0.2272F, 0.5146F, 1.4132F));
		...
		PartDefinition stalk3 = bodythreequarter.addOrReplaceChild("stalk3", CubeListBuilder.create().texOffs(17, 0).addBox(-2.2359F, -0.5111F, -0.4208F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.2641F, 0.5707F, -0.3202F, -0.8779F, 0.1689F, -0.8282F));
		...
		PartDefinition stalk4 = bodythreequarter.addOrReplaceChild("stalk4", CubeListBuilder.create().texOffs(17, 0).addBox(-2.2359F, -0.5111F, -0.4208F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.7359F, 3.5707F, -1.3202F, -1.2198F, -0.2578F, -2.631F));
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -21.5421F, -16.9252F, 7.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
