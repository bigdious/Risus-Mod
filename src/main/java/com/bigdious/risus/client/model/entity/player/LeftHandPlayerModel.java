...
public class LeftHandPlayerModel extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition create() {
		...
		var arm = partdefinition.addOrReplaceChild("arm", CubeListBuilder.create().texOffs(0, 0).addBox( -1.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.26F)), PartPose.offset(-5.0F, -2.0F, 0.0F));
		...
		var slimArm = partdefinition.addOrReplaceChild("slim_arm", CubeListBuilder.create().texOffs(1, 0).addBox(0.0F, 0.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.26F)), PartPose.offset(-5.0F, -2.0F, 0.0F));
