...
//				.texOffs(21, 47).addBox(-8.5F, -5.5F, -10.0F, 8.0F, 2.0F, 2.0F), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		head.addOrReplaceChild("upper_jaw", CubeListBuilder.create().texOffs(84, 47).addBox(-4.0F, -4.0F, -14.0F, 2.0F, 2.0F, 3.0F)
				...
				.texOffs(11, 0).addBox(4.0F, 0.0F, -8.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(-5.0F, 0.0F, -8.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(-5.0F, 1.0F, -11.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(4.0F, 1.0F, -11.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(4.0F, 1.0F, -14.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(-5.0F, 1.0F, -14.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(-4.0F, 1.0F, -15.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(-5.0F, 2.0F, -15.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(4.0F, 2.0F, -15.0F, 1.0F, 3.0F, 1.0F)
				.texOffs(11, 0).addBox(3.0F, 1.0F, -15.0F, 1.0F, 3.0F, 1.0F), PartPose.offset(0.0F, -6.0F, -7.0F));
	...
	public void renderToBuffer(PoseStack stack, VertexConsumer consumer, int light, int overlay, int color) {
		stack.pushPose();
		stack.translate(0.0D, -1.15F, -0.08D);
