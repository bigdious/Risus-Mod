...
public class SingerModel<T extends Singer> extends HierarchicalModel<T> {
	...
	public SingerModel(ModelPart root) {
		...
		this.pearl = body.getChild("pearl");
	...
	public static LayerDefinition create() {
		...
		pearl.addOrReplaceChild("pearlPart3", CubeListBuilder.create().texOffs(36, 114).addBox(-3.5F, -3.5F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.7854F, 0.0F));

		pearl.addOrReplaceChild("pearlPart2", CubeListBuilder.create().texOffs(36, 114).addBox(-3.5F, -3.5F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, -0.7854F, 0.0F));
		...
		RightArm.addOrReplaceChild("RightArm_r1", CubeListBuilder.create().texOffs(56, 49).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 30.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6378F, -0.1582F, 0.5759F));

		PartDefinition LeftArm = upperBody.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offset(9.0F, -4.0F, 0.0F));

		LeftArm.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(56, 49).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 30.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4765F, 0.0603F, -0.6691F));
		...
		topHead.addOrReplaceChild("brain", CubeListBuilder.create().texOffs(0, 5).addBox(-3.0F, -3.0F, -5.0F, 6.0F, 6.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.5F, 0.0F, 0.0F, 0.0F, 0.7854F));

		topHead.addOrReplaceChild("leftFace", CubeListBuilder.create().texOffs(0, 21).addBox(-3.0F, -10.0F, -6.0F, 6.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.0002F));

		topHead.addOrReplaceChild("rightFace", CubeListBuilder.create().texOffs(28, 11).addBox(-3.0F, -10.0F, -6.0F, 6.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -1.0F, 0.0F, 0.0F, 0.0F, -0.0002F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create(), PartPose.offset(-3.0F, 23.0F, 0.0F));

		RightLeg.addOrReplaceChild("RightLeg_r1", CubeListBuilder.create().texOffs(56, 46).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 30.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.618F, 0.3923F, -0.0181F));
		...
		LeftLeg.addOrReplaceChild("LeftLeg_r1", CubeListBuilder.create().texOffs(56, 49).mirror().addBox(9.126F, -18.8951F, 18.5305F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-9.9585F, -19.0936F, -18.2017F, -1.5708F, 0.0F, 0.0F));
