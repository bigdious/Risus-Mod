...
public class SingerModel<T extends Singer> extends HierarchicalModel<T> {
	...
	public static LayerDefinition create() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 89).addBox(-8.5F, 22.0F, -6.0F, 17.0F, 8.0F, 14.0F, new CubeDeformation(0.0F))
			.texOffs(0, 111).addBox(-4.5F, 30.0F, -3.0F, 9.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -14.0F, 0.0F));

		PartDefinition pearl = Body.addOrReplaceChild("pearl", CubeListBuilder.create().texOffs(36, 114).addBox(-3.5F, -3.5F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 22.0F, 1.0F));
		...
		PartDefinition upperBody = Body.addOrReplaceChild("upperBody", CubeListBuilder.create().texOffs(0, 67).addBox(-8.499F, -7.0F, -6.0F, 17.0F, 8.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 21.0F, 0.0F));

		PartDefinition RightArm = upperBody.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offset(-3.0F, -19.0F, 0.0F));

		PartDefinition RightArm_r1 = RightArm.addOrReplaceChild("RightArm_r1", CubeListBuilder.create().texOffs(56, 49).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 30.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.0F, 15.0F, 0.0F, -0.6378F, -0.1582F, 0.5759F));

		PartDefinition LeftArm = upperBody.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offset(5.0F, -19.0F, 0.0F));

		PartDefinition LeftArm_r1 = LeftArm.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(56, 49).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 30.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, 15.0F, 0.0F, -0.4765F, 0.0603F, -0.6691F));
		...
		PartDefinition topHead = Head.addOrReplaceChild("topHead", CubeListBuilder.create().texOffs(28, 11).addBox(0.0F, -11.0F, -6.0F, 6.0F, 10.0F, 12.0F, new CubeDeformation(0.0F))
			.texOffs(0, 21).addBox(-6.0F, -11.0F, -6.0F, 6.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 0.0F));
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create(), PartPose.offset(-2.0F, -2.0F, 0.0F));

		PartDefinition RightLeg_r1 = RightLeg.addOrReplaceChild("RightLeg_r1", CubeListBuilder.create().texOffs(56, 46).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 30.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 25.0F, 0.0F, -1.618F, 0.3923F, -0.0181F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.upperBody.xRot = -0.05F+0.025F * Mth.sin(ageInTicks * 0.05F+ 0.05F);
