...
public class AngelWingsModel extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition create() {
		...
		PartDefinition RightFeatherOne_r1 = RightThreeQuarter.addOrReplaceChild("RightFeatherOne_r1", CubeListBuilder.create().texOffs(0, 12).addBox(0.0F, -2.0F, -1.0F, 0.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.0F, 0.1309F, 0.0F));
		...
		PartDefinition RightFeatherTwo_r1 = RightTwoQuarter.addOrReplaceChild("RightFeatherTwo_r1", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -3.0F, -5.0F, 0.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.0F, 4.0F, 0.0F, -0.0436F, 0.0F));

		PartDefinition RightMemberThree_r1 = RightTwoQuarter.addOrReplaceChild("RightMemberThree_r1", CubeListBuilder.create().texOffs(44, 10).addBox(-0.4F, 0.0F, -0.5F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, 0.0F, 0.5F, 0.0F, 0.0F, -0.0074F));
		...
		PartDefinition RightFeatherThree_r1 = RightOneQuarter.addOrReplaceChild("RightFeatherThree_r1", CubeListBuilder.create().texOffs(0, -20).addBox(0.0F, -2.0F, -1.0F, 0.0F, 10.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition RightMemberFour_r1 = RightOneQuarter.addOrReplaceChild("RightMemberFour_r1", CubeListBuilder.create().texOffs(44, 0).addBox(-0.4F, 0.0F, -0.5F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, 0.0F, 0.5F, 0.0F, 0.0F, -0.0074F));
		...
		PartDefinition LeftFeatherOne_r1 = LeftThreeQuarter.addOrReplaceChild("LeftFeatherOne_r1", CubeListBuilder.create().texOffs(0, 12).mirror().addBox(0.0F, -2.0F, -1.0F, 0.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.0F, -0.1309F, 0.0F));
		...
		PartDefinition LeftFeatherTwo_r1 = LeftTwoQuarter.addOrReplaceChild("LeftFeatherTwo_r1", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, -3.0F, -5.0F, 0.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 4.0F, 4.0F, 0.0F, 0.0436F, 0.0F));

		PartDefinition LeftMemberThree_r1 = LeftTwoQuarter.addOrReplaceChild("LeftMemberThree_r1", CubeListBuilder.create().texOffs(44, 10).mirror().addBox(-0.6F, 0.0F, -0.5F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.1F, 0.0F, 0.5F, 0.0F, 0.0F, 0.0074F));
		...
		PartDefinition LeftFeatherThree_r1 = LeftOneQuarter.addOrReplaceChild("LeftFeatherThree_r1", CubeListBuilder.create().texOffs(0, -20).mirror().addBox(0.0F, -2.0F, -1.0F, 0.0F, 10.0F, 20.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition LeftMemberFour_r1 = LeftOneQuarter.addOrReplaceChild("LeftMemberFour_r1", CubeListBuilder.create().texOffs(44, 0).mirror().addBox(-0.6F, 0.0F, -0.5F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.1F, 0.0F, 0.5F, 0.0F, 0.0F, 0.0074F));
