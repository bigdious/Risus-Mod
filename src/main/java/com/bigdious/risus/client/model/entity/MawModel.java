...
public class MawModel<T extends Maw> extends HierarchicalModel<T> {
	...
	public static LayerDefinition create() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 0).addBox(-11.5F, -0.1F, -11.5F, 27.0F, 0.0F, 27.0F)
		...
		PartDefinition bigPincer1 = partdefinition.addOrReplaceChild("bigPincer1", CubeListBuilder.create().texOffs(0, 14).addBox(-3.0F, -7.0F, -2.5F, 5.0F, 10.0F, 5.0F), PartPose.offsetAndRotation(-12.0F, 24.0F, 0.0F, 0.0F, 0.0F, -0.4363F));
		...
		PartDefinition bigPincer2 = partdefinition.addOrReplaceChild("bigPincer2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 24.0F, -12.0F, 0.4363F, 0.0F, 0.0F));
		...
		PartDefinition bigPincer3 = partdefinition.addOrReplaceChild("bigPincer3", CubeListBuilder.create(), PartPose.offsetAndRotation(12.0F, 24.0F, 0.0F, 0.0F, 0.0F, 0.4363F));
		...
		PartDefinition bigPincer4 = partdefinition.addOrReplaceChild("bigPincer4", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 24.0F, 12.0F, -0.4363F, 0.0F, 0.0F));
		...
		PartDefinition bigPincer5 = partdefinition.addOrReplaceChild("bigPincer5", CubeListBuilder.create(), PartPose.offsetAndRotation(9.0F, 24.0F, 9.0F, -0.2182F, 0.0F, 0.2182F));
		...
		PartDefinition bigPincer6 = partdefinition.addOrReplaceChild("bigPincer6", CubeListBuilder.create(), PartPose.offsetAndRotation(-9.0F, 24.0F, 9.0F, -0.2182F, 0.0F, -0.2182F));
		...
		PartDefinition bigPincer7 = partdefinition.addOrReplaceChild("bigPincer7", CubeListBuilder.create(), PartPose.offsetAndRotation(-9.0F, 24.0F, -9.0F, 0.2182F, 0.0F, -0.2182F));
		...
		PartDefinition bigPincer8 = partdefinition.addOrReplaceChild("bigPincer8", CubeListBuilder.create(), PartPose.offsetAndRotation(9.0F, 24.0F, -9.0711F, 0.2182F, 0.0F, 0.2182F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(entity.biteAnim, MawAnimations.MAW_BITE, ageInTicks);
	}
