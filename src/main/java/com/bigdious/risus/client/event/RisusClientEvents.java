...
//		NeoForge.EVENT_BUS.addListener(RisusClientEvents::renderExBurning);
	...
	private static void clientSetup(FMLClientSetupEvent event) {
		...
		event.enqueueWork(() -> {
			...
			ItemProperties.register(RisusItems.ANGEL_WINGS.get(), Risus.prefix("oxidizing"), (stack, level, entity, seed) -> stack.getHoverName().getString().equalsIgnoreCase("oxidizing wings") ? 1.0F : 0.0F);

			ItemProperties.register(RisusItems.DIAMOND_TIPPED_ANGEL_WINGS.get(), Risus.prefix("broken"), (stack, level, entity, seed) -> AngelWingsItem.isFlyEnabled(stack) ? 0.0F : 1.0F);
			ItemProperties.register(RisusItems.DIAMOND_TIPPED_ANGEL_WINGS.get(), Risus.prefix("ashen"), (stack, level, entity, seed) -> stack.getHoverName().getString().equalsIgnoreCase("ashen wings") ? 1.0F : 0.0F);
			ItemProperties.register(RisusItems.DIAMOND_TIPPED_ANGEL_WINGS.get(), Risus.prefix("oily"), (stack, level, entity, seed) -> stack.getHoverName().getString().equalsIgnoreCase("oily wings") ? 1.0F : 0.0F);
			ItemProperties.register(RisusItems.DIAMOND_TIPPED_ANGEL_WINGS.get(), Risus.prefix("oxidizing"), (stack, level, entity, seed) -> stack.getHoverName().getString().equalsIgnoreCase("oxidizing wings") ? 1.0F : 0.0F);
	...
	private static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(RisusEntities.THROWN_BOOMSTICK.get(), ThrownBoomstickRenderer::new);
