...
public class ThrownBoomstickRenderer extends EntityRenderer<ThrownBoomstick> {
	...
	public static final ResourceLocation DRUMSTICK_LOCATION = Risus.prefix("textures/entity/drumstick.png");
	private final ThrownBoomstickModel model;
	private final ThrownBoomstickModel alternateModel;
	...
	public ThrownBoomstickRenderer(EntityRendererProvider.Context context) {
		...
		this.alternateModel = new ThrownBoomstickModel(context.bakeLayer(RisusModelLayers.THROWN_BOOMSTICK));
	}
