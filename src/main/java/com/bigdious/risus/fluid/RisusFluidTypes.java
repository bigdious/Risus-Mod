...
public class RisusFluidTypes {
	...
	public static final RegistryObject<FluidType> BLOOD_FLUID_TYPE = register("blood_fluid",
		FluidType.Properties.create().canHydrate(true).canDrown(false).canSwim(true).density(30).viscosity(5).canPushEntity(true).motionScale(10).fallDistanceModifier(3).sound(SoundAction.get("drink"),
