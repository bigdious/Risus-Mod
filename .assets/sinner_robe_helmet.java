...
public class sinner_robe_helmet<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.55F))
		...
		PartDefinition spyglass_4_r1 = bb_main.addOrReplaceChild("spyglass_4_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.0F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-2.0F, -3.5F, -12.2F, -1.5708F, 0.0F, 3.1416F));

		PartDefinition spyglass_2_r1 = bb_main.addOrReplaceChild("spyglass_2_r1", CubeListBuilder.create().texOffs(56, 19).addBox(-1.0F, -2.5F, -0.5F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -3.5F, -6.5F, -1.5708F, 0.0F, -3.1416F));

		PartDefinition spyglass_2_r2 = bb_main.addOrReplaceChild("spyglass_2_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.0F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(2.0F, -3.5F, -12.2F, -1.5708F, 0.0F, 3.1416F));

		PartDefinition spyglass_1_r1 = bb_main.addOrReplaceChild("spyglass_1_r1", CubeListBuilder.create().texOffs(56, 19).addBox(-1.0F, -2.5F, -0.5F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -3.5F, -6.5F, -1.5708F, 0.0F, -3.1416F));

		PartDefinition mask_r1 = bb_main.addOrReplaceChild("mask_r1", CubeListBuilder.create().texOffs(48, 0).addBox(-4.0F, -4.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(0.0F, -4.0F, -4.0F, 0.0F, 3.1416F, 0.0F));
