...
public class sinner_robe_helmet<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hoodie_part_3_r1 = bb_main.addOrReplaceChild("hoodie_part_3_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.5F)), PartPose.offsetAndRotation(0.0F, -1.6042F, 9.3159F, -1.1345F, 0.0F, 0.0F));
