...
public class ophanim<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "ophanim"), "main");
	...
	public ophanim(ModelPart root) {
		this.head = root.getChild("head");
		this.eyeCluster = root.getChild("eyeCluster");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -3.5F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.5F, 0.5F));

		PartDefinition eyeCluster = partdefinition.addOrReplaceChild("eyeCluster", CubeListBuilder.create().texOffs(21, 0).addBox(6.0F, -5.5F, 6.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		...
		.texOffs(21, 0).addBox(7.0F, -8.5F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 7.5F, 1.0F, 0.0F, 0.0F, -1.3963F));

		PartDefinition innerRing = partdefinition.addOrReplaceChild("innerRing", CubeListBuilder.create().texOffs(33, 0).addBox(-6.0F, 13.5F, -2.0F, 12.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 7.5F, 0.0F, -2.618F, 1.0036F, 3.1416F));
		...
		PartDefinition middleRing = partdefinition.addOrReplaceChild("middleRing", CubeListBuilder.create().texOffs(30, 5).addBox(-7.5F, 17.0F, -2.0F, 15.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 7.5F, 0.0F, 1.8646F, 0.0436F, -0.5219F));
		...
		PartDefinition outerRing = partdefinition.addOrReplaceChild("outerRing", CubeListBuilder.create().texOffs(27, 10).addBox(-9.0F, 20.5F, -2.0F, 18.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 7.5F, 0.0F, 0.8471F, 0.7844F, 0.4363F));
		...
		PartDefinition topRightWing = partdefinition.addOrReplaceChild("topRightWing", CubeListBuilder.create().texOffs(65, 0).addBox(0.0F, -2.0F, -2.0F, 9.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(17.0F, -9.0F, 0.0F, 0.1739F, 0.0151F, -1.3513F));
		...
		PartDefinition middleRightWing = partdefinition.addOrReplaceChild("middleRightWing", CubeListBuilder.create().texOffs(65, 0).addBox(0.0F, -2.0F, -2.0F, 9.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(24.0F, 7.0F, 0.0F, 0.124F, -0.1231F, -0.4876F));
		...
		PartDefinition bottomRightWing = partdefinition.addOrReplaceChild("bottomRightWing", CubeListBuilder.create().texOffs(65, 0).addBox(0.0F, -2.0F, -2.0F, 9.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(17.0F, 24.0F, 0.0F, -0.0456F, -0.1685F, 0.5711F));
		...
		PartDefinition topLeftWing = partdefinition.addOrReplaceChild("topLeftWing", CubeListBuilder.create().texOffs(65, 0).mirror().addBox(-9.0F, -2.0F, -2.0F, 9.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-17.0F, -9.0F, 0.0F, 0.1719F, -0.0302F, 1.35F));
		...
		PartDefinition middleLeftWing = partdefinition.addOrReplaceChild("middleLeftWing", CubeListBuilder.create().texOffs(65, 0).mirror().addBox(-9.0F, -2.0F, -2.0F, 9.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-24.0F, 7.0F, 0.0F, 0.124F, 0.1231F, 0.4876F));
		...
		PartDefinition bottomLeftWing = partdefinition.addOrReplaceChild("bottomLeftWing", CubeListBuilder.create().texOffs(65, 0).mirror().addBox(-9.0F, -2.0F, -2.0F, 9.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-17.0F, 24.0F, 0.0F, -0.0456F, 0.1685F, -0.5711F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		...
		eyeCluster.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		innerRing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		middleRing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		outerRing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		topRightWing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		middleRightWing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		bottomRightWing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		topLeftWing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		middleLeftWing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		bottomLeftWing.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}